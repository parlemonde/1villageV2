...
export default function PoserUneQuestionSuccess() {
    const t = useExtracted('app.(1village).(activities).poser-une-question.success');
    const tCommon = useExtracted('common');

    const { activity } = useContext(ActivityContext);

    const message = activity?.publishDate ? t('Votre question a été modifiée avec succès !') : t('Votre question a été publiée avec succès !');
