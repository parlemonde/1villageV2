        ...
        <Base>
            <PageLayout>
                ...
                <div className="width-900">
                    ...
                    <p className="text">
                        Tout comme l’objet magique, ce lieu extraordinaire doit permettre d’atteindre l’objectif du développement durable que vous
                        avez choisi à l’étape précédente.
                    </p>
                    <Grid container>
