...
export default function CreerUnJeuMonnaieStep4() {
    const t = useExtracted('app.(1village).(activities).creer-un-jeu.monnaie.4');
    ...
    return (
        <PageContainer>
            ...
            <CurrencyForm
                ...
                number={3}
                stepId={4}
                title={t('Choisissez un objet dont le prix moyen est élevé')}
            />
            <div className={styles.buttonsContainer}>
                <Button as="a" href="/creer-un-jeu/monnaie/3" color="primary" leftIcon={<ChevronLeftIcon />} label={tCommon('Étape précédente')} />
                <Button
                    disabled={!CURRENCY_GAME_STEPS_VALIDATORS.isStep4Valid(activity)}
                    onClick={() => router.push('/creer-un-jeu/monnaie/5')}
                    color="primary"
