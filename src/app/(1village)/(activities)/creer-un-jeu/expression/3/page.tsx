...
export default function CreerUnJeuExpressionStep3() {
    const t = useExtracted('app.(1village).(activities).creer-un-jeu.expression.3');
    ...
    return (
        <PageContainer>
            <Steps
                ...
                marginBottom="md"
            />
            <IdiomForm activity={activity} setActivity={setActivity} getOrCreateDraft={getOrCreateDraft} number={2} stepId={3} />
            <div className={styles.buttonsContainer}>
                <Button as="a" href="/creer-un-jeu/expression/2" label={tCommon('Étape précédente')} leftIcon={<ChevronLeftIcon />} color="primary" />
                <Button
                    onClick={() => router.push('/creer-un-jeu/expression/4')}
