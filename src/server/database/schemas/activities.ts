...
export const activities = pgTable('activities', {
    ...
    type: text('type', { enum: ACTIVITY_TYPES_ENUM as unknown as readonly [string, ...string[]] }).notNull(), // Use a varchar instead of pgEnum to be able to add new values without migrations
