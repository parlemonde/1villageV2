...
export const SecondPhase = () => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={() => {}} title="La phase 2 a commencé !" hasCloseButton={false} hasFooter={false} width="md" isFullWidth>
            <div className={styles.phaseContent}>
                ...
                <a href={FEEDBACK_FORM_URL} target="_blank" rel="noopener noreferrer" className={styles.phaseLink}>
                    {"Vos retours sur la phase 1 d'1Village"}
                </a>
                <div className={styles.phaseActions}>
                    <div className={styles.phaseOption}>
                        <p>{"Si vous n'avez pas encore découvert le pays mystère, restez en phase 1."}</p>
                        <Button label="Rester en phase 1" variant="outlined" color="primary" isUpperCase={false} onClick={handleStayPhase1} />
                    </div>
                    <div className={styles.phaseOption}>
                        <p>{'Pour échanger avec vos pélicopains, passez en phase 2.'}</p>
                        <Button label="Passer en phase 2" variant="outlined" color="primary" isUpperCase={false} onClick={handleGoToPhase2} />
                    </div>
                </div>
            </div>
        </Modal>
