...
export const ReportCard = ({ activity, shouldDisableButtons, onEdit, onDelete, children }: ActivityContentCardProps) => {
    ...
    const hint = activity.data?.defaultReport || activity.data?.customReport;
