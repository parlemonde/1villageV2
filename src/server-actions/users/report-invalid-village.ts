...
export const reportInvalidVillage = async (): Promise<ServerActionResponse> => {
    ...
    return sendEmail({
        to: adminEmail,
        subject: '[1Village] Village invalide — signalement professeur',
        emailType: EmailType.INVALID_VILLAGE,
        props: {
            userName: user.name,
