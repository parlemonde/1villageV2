...
export const saveParentInvitationMessage = async ({ parentInvitationMessage: _temp }: Partial<ParentInvitationMessageForm>) => {
    ...
    await db
        .update(classrooms)
        .set({
            // TODO migration parentInvitationMessage,
        })
